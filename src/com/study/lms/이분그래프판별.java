...
public class 이분그래프판별{
    public static int n;public static int m;public static boolean flag=true;
    public static ArrayList<Integer>[] graph;public static int[] v;
    ...
    public static void input(Scanner scan)
    {
      ...
      for(int i=0;i<m;i++){int x = scan.nextInt();int y=scan.nextInt();graph[x].add(y);graph[y].add(x);}
    }
}